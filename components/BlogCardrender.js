...
import BlogCard from "./HomeCards";
...
const BlogCardContainer=()=>{
    ...
    const blogPosts=[{
        ...
        title:'Blog Post 1',
        intro: 'This is the short introduction to blog post 1.'
    },
    {
        image:'https://img.freepik.com/free-photo/painting-mountain-lake-with-mountain-background_188544-9126.jpg',
        title:'Blog Post 2',
        intro: 'This is the short introduction to blog post 2.'
    },
    {
        image:'https://gratisography.com/wp-content/uploads/2024/03/gratisography-funflower-800x525.jpg',
        title:'Blog Post 1',
...
return(
    <div className="blog-cards-container">
        {
            blogPosts.slice(0,6).map((card,index)=>(
                <BlogCard
                    key={index}
                    image={card.image}
                    title={card.title}
